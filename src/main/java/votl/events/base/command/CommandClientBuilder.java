...
import votl.events.base.command.impl.CommandClientImpl;

/**
 * A simple builder used to create a {@link votl.events.base.command.impl.CommandClientImpl CommandClientImpl}.
 *
 * <p>Once built, add the {@link votl.events.base.command.CommandClient CommandClient} as an EventListener to
...
public class CommandClientBuilder {
	...
	/**
	 * Builds a {@link votl.events.base.command.impl.CommandClientImpl CommandClientImpl}
	 * with the provided settings.
	 * <br>Once built, only the {@link votl.events.base.command.CommandListener CommandListener},
	 * and {@link votl.events.base.command.Command Command}s can be changed.
	 *
	...
	public CommandClient build()
	{
		CommandClient client = new CommandClientImpl(ownerId, activity, status, serverInvite,
													 ...
													 shutdownAutomatically, executor, linkedCacheSize);
		if(listener!=null)
	...
	/**
	 * Adds a {@link votl.events.base.command.SlashCommand SlashCommand} and registers it to the
	 * {@link votl.events.base.command.impl.CommandClientImpl CommandClientImpl} for this session.
	 *
	 * @param  command
	...
	/**
	 * Adds and registers multiple {@link votl.events.base.command.SlashCommand SlashCommand}s to the
	 * {@link votl.events.base.command.impl.CommandClientImpl CommandClientImpl} for this session.
	 * <br>This is the same as calling {@link votl.events.base.command.CommandClientBuilder#addSlashCommand(SlashCommand) addSlashCommand(SlashCommand)} multiple times.
	 *
	 * @param  commands
	 *         The Commands to add
	 *
	...
	/**
	 * Adds a {@link votl.events.base.command.ContextMenu ContextMenu} and registers it to the
	 * {@link votl.events.base.command.impl.CommandClientImpl CommandClientImpl} for this session.
	 *
	 * @param  contextMenu
	...
	/**
	 * Adds and registers multiple {@link votl.events.base.command.ContextMenu ContextMenu}s to the
	 * {@link votl.events.base.command.impl.CommandClientImpl CommandClientImpl} for this session.
	 * <br>This is the same as calling {@link votl.events.base.command.CommandClientBuilder#addContextMenu(ContextMenu) addContextMenu(ContextMenu)} multiple times.
	 *
	 * @param  contextMenus
	...
	/**
	 * Sets the {@link votl.events.base.command.CommandListener CommandListener} for the
	 * {@link votl.events.base.command.impl.CommandClientImpl CommandClientImpl}.
	 *
	 * @param  listener
	 ...
	 *         built {@link votl.events.base.command.CommandClient CommandClient}
