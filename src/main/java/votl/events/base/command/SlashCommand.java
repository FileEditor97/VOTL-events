...
public abstract class SlashCommand extends Interaction {
	...
	/**
	 * The {@link votl.events.base.command.Command.Category Category} of the command.
	...
	public final void run(SlashCommandEvent event) {
		...
		if (event.isFromGuild()) {
			...
			try {
				bot.getCheckUtil()
				// check access
					.hasAccess(event, isAdminCommand(), author)
				// check user perms
	...
	/**
	 * Gets the {@link votl.events.base.command.SlashCommand#name Command.name} for the Command.
	 *
	...
	/**
	 * Gets the {@link votl.events.base.command.SlashCommand#help Command.help} for the Command.
	 *
	...
	/**
	 * Gets the {@link votl.events.base.command.SlashCommand#category Command.category} for the Command.
	 *
