 ...
 *
 * <p>This is implemented in {@link votl.events.base.command.impl.CommandClientImpl CommandClientImpl}
 ...
 * automatically to handle and execute {@link votl.events.base.command.Command Command}s.
 *
 ...
 * <ul>
 *     <li>{@link votl.events.base.command.Command Command}s may be added or removed.</li>
 *     <li>The {@link votl.events.base.command.CommandListener CommandListener} may be set.</li>
 * </ul>
 *
 ...
 *
 *         <p><b>4)</b> Do not provide strings when using {@link votl.events.base.command.CommandClientBuilder#setEmojis(String, String, String)
 ...
 *
 *         <p><b>5)</b> Avoid using {@link votl.events.base.command.impl.CommandClientImpl#linkIds(long,
...
public interface CommandClient {
	...
	/**
	 * Adds a single {@link votl.events.base.command.SlashCommand SlashCommand} to this CommandClient's
	 ...
	 * {@link votl.events.base.command.SlashCommand#name name} to the index that which they
	 ...
	 * <b>indexed calls</b>.
	 * <br>Indexed calls use a {@link java.util.HashMap HashMap} which links their
	 * {@link votl.events.base.command.Command#name name} to the index that which they
	 * are located at in the ArrayList they are stored.
	 *
	...
	/**
	 * Sets the {@link votl.events.base.command.CommandListener CommandListener} to catch
	 * command-related events thrown by this {@link votl.events.base.command.CommandClient CommandClient}.
	 *
	 * @param  listener
	 *         The CommandListener
	 */
	...
	/**
	 * Returns the current {@link votl.events.base.command.CommandListener CommandListener}.
	 *
	...
	/**
	 * Returns the list of registered {@link votl.events.base.command.SlashCommand SlashCommand}s
	 * during this session.
	 *
	...
	/**
	 * Gets the time this {@link votl.events.base.command.CommandClient CommandClient}
	 ...
	 */
	int getSlashCommandUses(SlashCommand command);

	/**
	 * Gets the number of uses for a {@link votl.events.base.command.Command Command}
	 ...
	 * {@link votl.events.base.command.Command#aliases alias} is provided! Also note that
	 * {@link votl.events.base.command.Command#children child commands} <b>ARE NOT</b>
	 ...
	 */
	int getSlashCommandUses(String name);
	 ...
	 *
	 * <p>This is used for methods such as {@link votl.events.base.command.CommandEvent#async(Runnable)
	 ...
	 *
	 * @see    votl.events.base.command.CommandClientBuilder#setLinkedCacheSize(int)
