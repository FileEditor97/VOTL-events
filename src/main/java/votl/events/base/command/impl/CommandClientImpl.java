 ...
 */
package votl.events.base.command.impl;
...
import votl.events.base.command.CommandListener;
import votl.events.base.command.ContextMenu;
...
import votl.events.base.utils.FixedSizeCache;
import votl.events.base.utils.SafeIdUtil;
...
/**
 * An implementation of {@link votl.events.base.command.CommandClient CommandClient} to be used by a bot.
 *
 ...
 * processes arguments, and provide them to a {@link votl.events.base.command.Command Command} for
...
public class CommandClientImpl implements CommandClient, EventListener {
	...
	@Override
	public int getSlashCommandUses(SlashCommand command)
	{
		return getSlashCommandUses(command.getName());
	}

	@Override
	public int getSlashCommandUses(String name)
	{
