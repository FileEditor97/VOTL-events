 ...
 *
 * Cooldown keys are generated via {@link votl.events.base.command.Command#getCooldownKey(CommandEvent)
 ...
 *
 * @see    votl.events.base.command.Command#cooldownScope Command.cooldownScope
 */
