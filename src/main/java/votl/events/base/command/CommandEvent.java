 ...
 * {@link votl.events.base.command.CommandClient CommandClient}, and String user arguments
 * compatible with all {@link votl.events.base.command.Command Command}s.
 * 
...
public class CommandEvent
{
	 ...
	 * @param  client
	 *         The {@link votl.events.base.command.CommandClient CommandClient}
	 */
	...
	/**
	 * Returns the {@link votl.events.base.command.CommandClient CommandClient}
	 ...
	 * be sent in two split Messages.
	 * 
	 * <p>It is also worth noting that unlike {@link votl.events.base.command.CommandEvent#reply(File,String) CommandEvent#reply(File, String)}
	 * and {@link votl.events.base.command.CommandEvent#reply(String,File,String) CommandEvent#reply(String, File, String)},
	...
	/**
	 * Uses the {@link votl.events.base.command.CommandClient#getScheduleExecutor() client's executor}
