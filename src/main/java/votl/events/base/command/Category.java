 ...
 * {@link votl.events.base.command.CommandEvent CommandEvent} doesn't meet
...
public class Category
{
	 ...
	 * {@link votl.events.base.command.Command.Category#test(votl.events.base.command.CommandEvent)}
	 * returns {@code false}.
	 *
	 * @param  name
	 *         The name of the Category
	 ...
	 *
	 * @param  event
	 *         The {@link votl.events.base.command.CommandEvent CommandEvent}
